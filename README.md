...
| `@di-framework/actors` | [![latest npm version](https://img.shields.io/npm/v/%40di-framework%2Factors?label=&logo=npm&color=white&logoColor=cb3837)](https://www.npmjs.com/package/@di-framework/actors) | Local virtual actors and transactional storage | [![npm unpacked size](https://img.shields.io/npm/unpacked-size/%40di-framework%2Factors?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/actors) | [![line coverage](https://img.shields.io/endpoint?url=https%3A%2F%2Fdocs.di-framework.dev%2Fcoverage%2Factors.json)]() | [![npm weekly downloads](https://img.shields.io/npm/dw/%40di-framework%2Factors?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/actors) |
...
| `@di-framework/queues` | [![latest npm version](https://img.shields.io/npm/v/%40di-framework%2Fqueues?label=&logo=npm&color=white&logoColor=cb3837)](https://www.npmjs.com/package/@di-framework/queues) | Durable job queues with local development and wasmCloud integration | [![npm unpacked size](https://img.shields.io/npm/unpacked-size/%40di-framework%2Fqueues?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/queues) | [![line coverage](https://img.shields.io/endpoint?url=https%3A%2F%2Fdocs.di-framework.dev%2Fcoverage%2Fqueues.json)]() | [![npm weekly downloads](https://img.shields.io/npm/dw/%40di-framework%2Fqueues?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/queues) |
...
| `@di-framework/platform` | [![latest npm version](https://img.shields.io/npm/v/%40di-framework%2Fplatform?label=&logo=npm&color=white&logoColor=cb3837)](https://www.npmjs.com/package/@di-framework/platform) | Shared Pulumi infrastructure for wasmCloud platforms | [![npm unpacked size](https://img.shields.io/npm/unpacked-size/%40di-framework%2Fplatform?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/platform) | [![line coverage](https://img.shields.io/endpoint?url=https%3A%2F%2Fdocs.di-framework.dev%2Fcoverage%2Fplatform.json)]() | [![npm weekly downloads](https://img.shields.io/npm/dw/%40di-framework%2Fplatform?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/platform) |
...
| `@di-framework/wasmcloud` | [![latest npm version](https://img.shields.io/npm/v/%40di-framework%2Fwasmcloud?label=&logo=npm&color=white&logoColor=cb3837)](https://www.npmjs.com/package/@di-framework/wasmcloud) | Native wasmCloud WIT service bindings and DI | [![npm unpacked size](https://img.shields.io/npm/unpacked-size/%40di-framework%2Fwasmcloud?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/wasmcloud) | [![line coverage](https://img.shields.io/endpoint?url=https%3A%2F%2Fdocs.di-framework.dev%2Fcoverage%2Fwasmcloud.json)]() | [![npm weekly downloads](https://img.shields.io/npm/dw/%40di-framework%2Fwasmcloud?label=&logo=npm)](https://www.npmjs.com/package/@di-framework/wasmcloud) |
